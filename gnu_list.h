/*
 * Author: Even <chenyuwen1@meizu.com>
 * Date  : 2023/07/12
 */
...
#define LIST_POISON1 ((struct list_head *)0x1234)
#define LIST_POISON2 ((struct list_head *)0x4321)
...
static inline int __list_add_valid(struct list_head *newlist,
...
static inline void __list_add(struct list_head *newlist,
			      ...
			      struct list_head *next)
{
	if (!__list_add_valid(newlist, prev, next))
		return;
 ...
 * @newlist : the new element to insert
 *
